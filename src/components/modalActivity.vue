          ...
          <div class="card border-0">
            ...
            <div class="card-body px-0 pt-5 pb-0">
              ...
              align-items-md-center align-items-start flex-column flex-md-row">
                <p class="w-50">
                  <i class="bi bi-clock text-primary me-3"></i>{{data.EndTime}}</p>
                <p class="w-50">
              ...
              align-items-md-center align-items-start flex-column flex-md-row">
                <p class="w-50">
                  <i class="bi bi-geo-alt-fill text-primary me-3"></i>{{data.Location}}</p>
                <p class="w-50">
                  <i class="bi bi-bookmark text-primary me-3"></i>{{data.Class1}}</p>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  mounted() {
    this.ActivityModal = new Modal(this.$refs.showActivityModal, {
      keyboard: false,
    });
  },
};
